...
// const Subscription = require('../../model/subscription').default;
// const utils = require('../../middleware/utils').default;
...
//   if (
//     subscription?.history?.some((x) => x.session.id === sessionId) ||
//     subscription?.subscription?.session.id === sessionId
//   ) {
